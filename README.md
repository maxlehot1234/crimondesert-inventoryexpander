...
**Example:** if your max is set to 200 and you buy a bag that would normally give you slot 91, your inventory stays at 200. However, that purchase is still tracked internally. If you later restore vanilla values, you won't see 50 slots — you'll see 91, because that bag was counted all along.
